...
/* I originally had this more concise using another constant to
   format the parts that were all identical from the beginning
   of the URIs, but the library didn't render those images properly.
   I'd also like to discuss how to fix the height of the carousel
   since right now it's taking up too much space for my tastes.
 */
